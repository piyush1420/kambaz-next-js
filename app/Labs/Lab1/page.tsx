...
<div id="wd-lists">
  ...
  My favorite recipe: Poha
  <ol id="wd-your-favorite-recipe">
    <li>Add oil in a Pan.</li>
    <li>Wash the poha and drain the water.</li>
    <li>If the oil is hot add cumin, mustard seeds, onion, curryleaves, turmeric.</li>
    <li>Cook till onions become golden brown.</li>
    <li>Add the wet poha into the pan.</li>
    <li>Add salt, chilli powder and Cook.</li>
    <li>Serve and enjoy!</li>
  </ol>
  ...
  <ul id="wd-your-books">
    ...
    <li>Youtube the teacher</li>
    <li>Google the doubt solver</li>
    <li>Job Market and Trump</li>
