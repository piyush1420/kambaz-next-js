...
export default function TOC() {
  ...
  return (
    <Nav variant="pills">
      ...
      <NavItem>
        <NavLink href="https://github.com/piyush1420/kambaz-next-js/tree/a5" target="_blank" rel="noopener noreferrer">
          React GitHub (a5)
        </NavLink>
      </NavItem>
      <NavItem>
        <NavLink href="https://github.com/piyush1420/kambaz-node-server-app" target="_blank" rel="noopener noreferrer">
          Server GitHub
        </NavLink>
      </NavItem>
      <NavItem>
        <NavLink href="https://kambaz-node-server-app-g845.onrender.com/" target="_blank" rel="noopener noreferrer">
          Server on Render
        </NavLink>
      </NavItem>
    </Nav>
