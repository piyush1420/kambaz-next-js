      ...
      <div>
        ...
        <div id="wd-details" className="ms-5 mt-3 mb-5 w-50">
          ...
          <div className="row mt-2">
            ...
            <div className="col-3">{quiz.webcam ? "Yes" : "No"}</div>
          </div>

          <div className="row mt-2">
            <div className="col-9">
              <b>Lock Question After Answering</b>
            </div>
            <div className="col-3">{quiz.lockQafterA ? "Yes" : "No"}</div>
          </div>
