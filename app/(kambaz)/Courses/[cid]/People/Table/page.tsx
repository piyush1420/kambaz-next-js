   ...
   <Table striped>
    ...
    <tbody>
     <tr><td className="wd-full-name text-nowrap">
      ...
      <td className="wd-role">STUDENT</td>
      <td className="wd-last-activity">2022-09-01</td>
      ...
      <td className="wd-role">STUDENT</td>
      <td className="wd-last-activity">2022-09-12</td>
      <td className="wd-total-activity">11:30:00</td></tr>
      ...
      <td className="wd-role">STUDENT</td>
      <td className="wd-last-activity">2024-09-12</td>
      <td className="wd-total-activity">12:30:00</td></tr>
